...
public class TagsLayout extends ViewGroup {
    ...
    public TagsLayout(Context context, AttributeSet attrs) {
        ...
        if (attrArray != null) {
            childHorizontalSpace = attrArray.getDimensionPixelSize(R.styleable.TagsLayout_tagHorizontalSpace, 10);
            childVerticalSpace = attrArray.getDimensionPixelSize(R.styleable.TagsLayout_tagVerticalSpace, 10);
            attrArray.recycle();
        }
    }
